...
import { addHavesWants } from '../../actions/profile';

const AddHavesWants = ({ addHavesWants, history }) => {
    const [formData, setFormData] = useState({
        haves: '',
        wants: ''
    });

    const { haves, wants } = formData;
    ...
    return (
        <Fragment>
            ...
            Add Haves & Wants to your profile
            </h1>
            <p className="lead">
            ...
            {/* <form className="form" onSubmit={e => {
                e.preventDefault();
                addHavesWants(formData,history);
            }}>
...
AddHavesWants.propTypes = {
    addHavesWants: PropTypes.func.isRequired
}

export default connect(null, { addHavesWants })(withRouter(AddHavesWants));
